  ...
  return (
    <a href={href} target="_blank" className="group" rel="noreferrer">
      <div className="relative aspect-square bg-black border border-white/10 overflow-hidden">
        ...
        <div className="absolute inset-0 border border-white/0 group-hover:border-white/100 transition-all duration-300 group-hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] pointer-events-none" />
        <div className="absolute inset-0 flex flex-col justify-end px-2 pt-1 pb-2 sm:px-4 sm:pb-4 sm:pt-2">
          <h3 className="text-[0.9rem] sm:text-base font-normal sm:font-semibold text-white group-hover:text-white/70 transition-colors leading-snug break-normal">
            {title}
          </h3>
        </div>
