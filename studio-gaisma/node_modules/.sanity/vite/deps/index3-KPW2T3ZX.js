import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-BMJVRQCG.js";
import "./chunk-PGNUTYKC.js";
import {
  Button,
  ErrorBoundary,
  NEVER,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-C6SOP4FR.js")),
  document: (0, import_react.lazy)(() => import("./pane-NDEI7JMR.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-NDEI7JMR.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-5EPQWABY.js"))
};
...
//# sourceMappingURL=index3-KPW2T3ZX.js.map
